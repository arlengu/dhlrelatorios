$(document).ready(function () {
    ...
    $(".confirm-animation").on("click", function () {
        Swal.fire({
            title: "Are you sure?",
            text: "You won't be able to revert this!",
            type: "warning",
    ...
    $(".customize-text").on("click", function () {
        Swal.fire({
    ...
    $(".custom-padding-width").on("click", function () {
        Swal.fire({
            title: "Custom width, padding, background.",
            width: 600,
            padding: 100,
            background: "#fff url(../../../app-assets/images/backgrounds/bg-2.jpg)",
            confirmButtonClass: "btn btn-primary",
            buttonsStyling: false
        });
    });

    $(".custom-grow").on("click", function () {
        Swal.fire({
            title: "Grow",
            text: "Modal window can grow.",
            grow: "fullscreen",
            confirmButtonClass: "btn btn-primary",
            buttonsStyling: false
        });
    ...
    $(".custom-backdrop").on("click", function () {
        Swal.fire({
            ...
            text: "I will disable the default backdrop.",
            backdrop: false,
            confirmButtonClass: "btn btn-primary",
            buttonsStyling: false
        });
